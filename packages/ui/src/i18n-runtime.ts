...
export const sharedLocaleResources: LocaleResources = {
  en: {
    ...
    "state.noPermissionMessage": "You do not have permission to view this page. Confirm your workspace role and try again.",
    ...
    "shell.userMenu.workspaceSettings": "Workspace Settings",
  ...
  fr: {
    ...
    "state.noPermissionMessage": "Vous n’avez pas l’autorisation de voir cette page. Vérifiez votre rôle d’espace de travail et réessayez.",
    ...
    "shell.userMenu.workspaceSettings": "Paramètres de l’espace de travail",
  ...
  ar: {
    ...
    "state.noPermissionMessage": "ليس لديك إذن لعرض هذه الصفحة. تحقق من دور مساحة العمل وحاول مرة أخرى.",
    ...
    "shell.userMenu.workspaceSettings": "إعدادات مساحة العمل",
